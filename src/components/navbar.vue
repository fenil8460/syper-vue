                ...
                <div class="col-5 ml-auto order-2 text-right d-none d-lg-block">
                    <form class="navbar__search">
                        <input class="form-control mr-sm-2" type="text"
                            placeholder="Nurse , Physio, Therapist , Oncologist, Patient skill" aria-label="Search"
                            id="product_name" data-autocompleturl="https://boozards.com/merchant-product/search">
                        ...
                        <ul class="site-menu main-menu js-clone-nav ml-auto ">
                            <li class="active">
                                <a href="/" class="nav-link">
                                    <!-- <img src="../src/assets/images/menu/menu-home.png" alt="" class="w-20"> -->
                                     Home</a>
                            </li>
                            <!-- <li><a href="about.html" class="nav-link"><img src="/images/menu/menu-merchants.png'" alt="" class="w-20"> Merchant</a></li> -->
